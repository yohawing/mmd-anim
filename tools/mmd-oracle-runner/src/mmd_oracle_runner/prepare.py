...
def _prepare_rust(case: OracleCase, result: dict[str, Any], runner: CommandRunner, repo_root: Path, scene_path: Path, model_path: Path) -> bool:
    ...
    if any(skipped.values()):
        _fail(result, "artifacts", "Rust PMM backend skipped VMD frames without matching model names")
        return False
    result["comparison"] = {
        "status": "generated",
        "reason": "PMM was generated by the repository Rust format writer; host playback remains a separate record gate",
