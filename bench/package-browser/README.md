...
固定した Candidate B KTX2 10件について、平文EntryとAES-256-GCM暗号化Entryを実Chromeで比較する保守者向けハーネスです。公式の固定Three.js KTX2Loaderを通し、テクスチャ付きquadのGPU完了までを測ります。readbackとhashは計測外の妥当性検証です。
